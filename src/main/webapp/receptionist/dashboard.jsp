                ...
                <%@ page import="java.time.LocalDate" %>
                    <% if (session.getAttribute("role")==null || !"receptionist".equals(session.getAttribute("role"))) {
                        ...
                        List<Booking> todaysBookings = bookingDAO.getAllBookings();
                            ...
                            "confirmed".equals(booking.getStatus())) todaysCheckIns++;
                                ...
                                <main class="dashboard-main-content" id="mainContent">
                                    <div class="container-fluid">
                                        <div class="flex justify-between items-center mb-4">
                                            <h2 style="margin:0;"><i class="bi bi-speedometer2"
                                                    style="margin-right:.5rem;color:#1298c7;"></i>Reception Desk</h2>
                                            <span style="color:#6c757d;font-size:.95rem;"><i class="bi bi-calendar3"
                                        ...
                                        <div class="grid grid-cols-4 gap-4 mb-4">
                                            <div class="stats-card">
                                                <div class="stats-icon" style="background-color:var(--palm-green);"><i
                                            ...
                                            <div class="stats-card">
                                                <div class="stats-icon" style="background-color:var(--sunset-orange);">
                                                    <i class="bi bi-door-closed"></i></div>
                                                <div>
                                                    <div class="stats-value">
                                                        <%= occupiedRooms %>
                                                    </div>
                                            ...
                                            <div class="stats-card">
                                                <div class="stats-icon" style="background-color:var(--ocean-blue);"><i
                                            ...
                                            <div class="stats-card">
                                                <div class="stats-icon" style="background-color:var(--primary);"><i
                                                        ...
                                                        <tbody>
                                                            <% boolean hasArrivals=false; for (Booking booking :
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><span
                                                                            class="badge bg-warning text-dark">Confirmed</span>
                                                                    </td>
                                                                </tr>
                                                                <% } } if (!hasArrivals) { %>
                                                                    <tr>
                                                                        <td colspan="6" class="text-center text-muted"
                                                                            style="padding:2rem;">No arrivals expected
                                                                            today</td>
                                                                    </tr>
                                                                    <% } %>
                                                        </tbody>
