        ...
        <%@ page import="com.example.oceanviewresortnew.model.*" %>
            <%@ page import="java.util.*" %>
                <% if (session.getAttribute("role")==null || !"admin".equals(session.getAttribute("role"))) {
                    ...
                    BookingDAO(); UserDAO userDAO = new UserDAO(); RoomDAO roomDAO = new RoomDAO(); List<Booking> allBookings = bookingDAO.getAllBookings();
                    List<User> allUsers = userDAO.getAllUsers(); List<Room> availableRooms = roomDAO.getAvailableRooms();
                    %>
                    <!DOCTYPE html>
                    <html lang="en">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <% if (request.getParameter("error") !=null) { %>
                                        <div class="alert alert-error">
                                            ...
                                            <% } else if ("invalid_room".equals(request.getParameter("error"))) { %>
                                        ...
                                        <form action="${pageContext.request.contextPath}/bookings" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="userId" class="form-select" required>
                                                    ...
                                                    <% for (User user : allUsers) { if ("customer".equals(user.getRole())) { %>
                                                ...
                                                <select name="roomId" class="form-select" required>
                                                    ...
                                                    <% for (Room room : availableRooms) { %>
                                                        <option value="<%= room.getId() %>">
                                                            Room <%= room.getRoomNumber() %> - <%= room.getRoomType() %> (LKR <%= room.getPricePerNight() %>/night)
                                                        </option>
                                                    <% } %>
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="numberOfGuests" class="form-input" min="1" max="10"
                                                    required>
                                            </div>
